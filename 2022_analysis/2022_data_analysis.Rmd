...
[SA data](https://datacatalog.cookcountyil.gov/browse?tags=state%27s+attorney+case-level&sortBy=most_accessed)
...
# PSA and release condition relationship
```{r}
test <- obs_data %>%
  filter(psa_nca > 0)

# looking at data quality, I don't think there are enough observations. I can go pull them from my notes but not right now.
```
